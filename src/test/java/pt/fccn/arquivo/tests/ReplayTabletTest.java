 ...
 *
 */
public class ReplayTabletTest extends WebDriverTestBaseParalell{
    /**
     * PRE-PROD TESTS
     ...
     */
    public ReplayTabletTest(String os, String version, String browser, String deviceName, String deviceOrientation) {
