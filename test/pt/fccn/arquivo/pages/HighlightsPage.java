...
public class HighlightsPage {
	...
	private static final String titleFirstPortuguesePagePT = "Home Page de Portugal / Portugal Home Page - preservada pelo Arquivo.pt";
	private static final String titleFirstPortuguesePageEN = "Home Page de Portugal / Portugal Home Page - preserved by Arquivo.pt";
	private static final String titleSmithsonianPT ="The Smithsonian Institution Home Page - preservada pelo Arquivo.pt";
	private static final String titleSmithsonianEN ="The Smithsonian Institution Home Page - preserved by Arquivo.pt";
	private static final String titleClixPT = "UEFA Euro 2004  - preservada pelo Arquivo.pt";
	private static final String titleClixEN = "UEFA Euro 2004  - preserved by Arquivo.pt";
	private static final String titleExpoPT = "EURO - O que é o euro ? - preservada pelo Arquivo.pt";
	private static final String titleExpoEN = "EURO - O que é o euro ? - preserved by Arquivo.pt";
	private static final String titlePublicoPT = "PUBLICO - preservada pelo Arquivo.pt";
	private static final String titlePublicoEN = "PUBLICO - preserved by Arquivo.pt";
	private static final String titleSapoPT = "Projecto HidroNet - Links 1 - preservada pelo Arquivo.pt";
	private static final String titleSapoEN = "Projecto HidroNet - Links 1 - preserved by Arquivo.pt";
	private static final String titleTimPT = "Tim Berners-Lee - preservada pelo Arquivo.pt";
	private static final String titleTimEN = "Tim Berners-Lee - preserved by Arquivo.pt";
	private static final String titlePresidenciaisPT ="portuguese presidentials of 2001 - preservada pelo Arquivo.pt";
	private static final String titlePresidenciaisEN ="portuguese presidentials of 2001 - preserved by Arquivo.pt";
	private static final String titleEuroPT ="Futebol Internacional - Notícias do dia - preservada pelo Arquivo.pt";
	private static final String titleEuroEN ="Futebol Internacional - Notícias do dia - preserved by Arquivo.pt";
	private static final String titleEloyEN ="Eloy Rodrigues - HOME PAGE - preservada pelo Arquivo.pt";
	private static final String titleEloyPT ="Eloy Rodrigues - HOME PAGE - preserved by Arquivo.pt";
	private static final String titlePortugalTelecomPT ="P O R T U G A L T E L E C O M - preservada pelo Arquivo.pt";
	private static final String titlePortugalTelecomEN ="P O R T U G A L T E L E C O M - preserved by Arquivo.pt";
	private static final String titleMinistrePT ="Ministère de l'Education Nationale - preservada pelo Arquivo.pt";
	private static final String titleMinistreEN ="Ministère de l'Education Nationale - preserved by Arquivo.pt";
	private static final String titleSicPT ="SIC Online - Cavaco Silva em Bragança - preservada pelo Arquivo.pt";
	private static final String titleSicEN ="SIC Online - Cavaco Silva em Bragança - preserved by Arquivo.pt";
	private static final String titleCimiterioPT ="Visita ao Cemitério - preservada pelo Arquivo.pt";
	private static final String titleCimiterioEN ="Visita ao Cemitério - preserved by Arquivo.pt";
	private static final String titleSapoDesportoPT ="Sapo Infordesporto - preservada pelo Arquivo.pt";
	private static final String titleSapoDesportoEN ="Sapo Infordesporto - preserved by Arquivo.pt";
	private static final String titleNimasPT ="NIMAS - FITAS EM CARTAZ - preservada pelo Arquivo.pt";
	private static final String titleNimasEN ="NIMAS - FITAS EM CARTAZ - preserved by Arquivo.pt";
	private static final String titleXLDBPT ="Referencias - preservada pelo Arquivo.pt";
	private static final String titleXLDBEN ="Referencias - preserved by Arquivo.pt";
	private static final String titleBosniaPT ="BOSNIA NOW - preservada pelo Arquivo.pt";
	private static final String titleBosniaEN ="BOSNIA NOW - preserved by Arquivo.pt";
	private static final String titleFitasPT ="NIMAS - FITAS EM CARTAZ - preservada pelo Arquivo.pt";
	private static final String titleFitasEN ="NIMAS - FITAS EM CARTAZ - preserved by Arquivo.pt";
	private static final String titleBeachcamPT = "BeachCam - Praia do Guincho - preservada pelo Arquivo.pt";
    	...
    	try{
	        ...
	        for (int i = 0; i < currentNumberOfHighlights; i++) {
        		WebElement currentHighLightAnchor = (new WebDriverWait(driver, 25)) /* Wait Up to 25 seconds should throw RunTimeExcpetion*/
        		    .until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*/ul/li/a[class=\"external-link\"]")));     
