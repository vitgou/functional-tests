 ...
 */
@RunWith( Suite.class )
@SuiteClasses( { CommonQuestionsTest.class , ExamplesTest.class , FooterTest.class  , NewsTest.class } )
//TODO PublicationsTest.class  ,  NavigationTest.class , SearchTest.class , SiteMapTest.class
