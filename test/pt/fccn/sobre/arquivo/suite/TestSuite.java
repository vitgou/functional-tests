 ...
 */
@RunWith( Suite.class )
@SuiteClasses( { CommonQuestionsTest.class , ExamplesTest.class , FooterTest.class , PublicationsTest.class } )
//TODO ,  ,  , , NewsTest.class ,  NavigationTest.class , SearchTest.class , SiteMapTest.class
