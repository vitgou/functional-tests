 ...
 */
@RunWith( Suite.class )
@SuiteClasses( {  NavigationTest.class, PublicationsTest.class } )
//TODO CommonQuestionsTest.class , ExamplesTest.class , FooterTest.class  , NewsTest.class , SearchTest.class , SiteMapTest.class, 
